...
&nbsp; 
<p style="font-size:18px;color: black;"> Explicação das variáveis da planilha de faxinas: </p>
...
<p style="font-size:18px;color: black;"> Mudanças na etapa de limpeza dos dados: </p>
...
&nbsp;     
<p style="font-size:18px;color: black;">Ideias de análises e gráficos: </p>   
...
# colunas de 1 a 6
kable(head(faxinas201819[,c(1:6)], 10), digits = 2, align = 'c') %>% 
  kableExtra::kable_styling(full_width = FALSE, position = "center", 
                            font_size = 10,row_label_position = "l", 
                            html_font = "helvetica")

# colunas de 7 a 10
kable(head(faxinas201819[,c(7:10)], 10), digits = 2, align = 'c') %>% 
  kableExtra::kable_styling(full_width = FALSE, position = "center", 
                            font_size = 10,row_label_position = "l", 
                            html_font = "helvetica")
...
# excel B2 a R12 ate o dia 31/01/2021
faxinas202021 <-
...
# removendo a linha 184 pois esta duplicada diferindo apenas na coluna Feedback colhido?
faxinas <- faxinas[-c(184),]
...
# colunas de 1 a 6
kable(head(faxinas[,c(1:6)], 10), digits = 2, align = 'c') %>% 
  kableExtra::kable_styling(full_width = FALSE, position = "left", 
                            font_size = 10,row_label_position = "l", 
                            html_font = "helvetica")

# colunas de 7 a 12, menos a 11
kable(head(faxinas[,c(7,8,9,10,12)], 10), digits = 2, align = 'c') %>% 
  kableExtra::kable_styling(full_width = FALSE, position = "center", 
                            font_size = 10,row_label_position = "l", 
                            html_font = "helvetica")
...
# colunas de 13 a 17
kable(head(faxinas[,c(13:17)], 10), digits = 2, align = 'c') %>% 
  kableExtra::kable_styling(full_width = FALSE, position = "center", 
                            font_size = 10,row_label_position = "l", 
                            html_font = "helvetica")
...
### Observando as 10 primeiras linhas da Planilha de disponibilidade:
