...
faxinas201920$`Ocorreu?` <- as.character(as.numeric(faxinas201920$`Ocorreu?`))
...
- | Nas duas planilhas os endereços começam por R.,R, rua, Rua, ou não tem Rua e somente o nome do endereço.  Seria bom padronizar nesse caso também para todos que são Rua ou Avenida começarem com Rua e Av.;
