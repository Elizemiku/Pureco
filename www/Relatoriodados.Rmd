...
output: 
  html_document:
    ...
    toc_float:
      ...
      smooth_scroll: true
---
<!--argumento para deixar a página mais a esquerda -->
<style>
body {
    position: absolute;
    left: 0px;}
...
- | Nas duas planilhas os endereços começam por R.,R, rua, Rua, ou não começam com Rua e há somente o restante do nome do endereço. Seria bom padronizar nesse caso também para todos que são Rua ou Avenida começarem com Rua e Av., por exemplo.


#### Ideias de análises e gráficos:

- | Quantidade de faxinas por dia da semana - feito
- | Mapas, acrescentar latitude e longitude de acordo com os endereços (pacote rselenion)
- | Gráfico que mostre a porcentagem de faxinas que não ocorreram e que foram remarcadas ou não.
