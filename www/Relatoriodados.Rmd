...
faxinas201819 <- faxinas201819 %>%
  ...
  mutate_at(c("Cliente", "Endereço"), funs(ifelse(. == "-" |
                                                    . == "--" | . == "/" , NA, .))) %>%
...
faxinas201920 <- faxinas201920 %>% 
  mutate(`Ocorreu?` = as.logical(`Ocorreu?`))
...
# mudança_palavras(faxinas201920$Cliente)
# mudança_palavras(faxinas201920$Endereço)
```
