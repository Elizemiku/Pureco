...
<p style="font-size:18px;color: blue;">Explicação das variáveis das planilhas de faxinas: </p>

- Planilha 1: período de 2018 a 2019. 
  ...
  - | **Feedback Mulher**: Nota que a mulher deu para o seu cliente. 
  - | **Comentários**: Comentários gerais sobre os serviços realizados.
  
- Planilha 2: período de 2019 a 2020 (atualmente)
  - | **Data**: Data marcada da faxina.
  - | **Ocorreu?**: Representa se a faxina marcada na data ocorreu.
  ...
  - | **Valor**: Valor cobrado da faxina em reais.
  - | **Cliente**: Nome do cliente que pediu a faxina.
  - | **Tipo**: Representa se o cliente já havia pedido antes uma faxina ou se um pedido de faxina novo.
  - | **Endereço**: Endereço do cliente que pediu a faxina.
  - | **Região**: Região que foi pedido a faxina.
  - | **Feedback Colhido?**: Representa se o feedback do cliente foi anotado.
  - | **Onde foi Colhido?**: Local em que o feedback foi anotado. 
...
- | Coloquei as 2 planilhas tanto separadas quanto juntas para opção de download.
...
- | Ao juntar as planilhas tive que arrumar alguns problemas como:
  - | Removi o valor **2,5 ~ 3,0** da coluna **Feedback cliente** e **Nota feedback Mulher**, pois não consigo converter essa expressão para um valor numérico. 
  - | Nenhuma padronização dos dados.
  - | Na hora de juntar as planilhas tive que mudar o nome das colunas **Feedback Cliente** e **Feedback**
**Mulher** da planilha mais antiga para **Nota feedback Cliente**, para juntar com os dados da planilha
nova. 
...
- | Nas colunas: **Feedback cliente** e **Feedback mulher** evitar colocar os dados como : **2,5 ~ 3,0** pois
não é possível trabalhar com a análise nesse formato de nota, nesse caso, por exemplo, poderíam fazer uma
...
- | Padronizar o espaço entre as palavras escritas nas colunas para que não falte espaço ou sobre espaço entre
as palavras. 
