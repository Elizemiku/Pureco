...
Explicação das variáveis das planilhas de faxinas: 
...
- Planilha 2: período de 2019 a 2020 (atualmente)
  ...
  - | *Valor*: Valor cobrado da faxina em reais.
  - | *Cliente*: Nome do cliente que pediu a faxina.
  - | *Tipo*: Representa se o cliente já havia pedido antes uma faxina ou se um     |
    | pedido de faxina novo.
  - | *Endereço*: Endereço do cliente que pediu a faxina.
  ...
  - | *Feedback Cliente*: Comentários do cliente sobre a faxina.
  - | *Comentários*: Comentários gerais sobre os serviços realizados.

Mudanças:

- | Deixei as 2 planilhas tanto separadas quanto juntas para opção de download.
- | Ao juntar as planilhas tive que arrumar alguns problemas como:
  - | Removi o valor **2,5 ~ 3,0** da coluna **Feedback cliente**, pois não consigo converter essa 
    | expressão para um valor numérico. 
  - | Padronização das variáveis.
  - | Na hora de juntar as planilhas tive que transformar a variável *
  - | Na parte de limpeza dos dados, foram removidas todas as colunas vazias ou     
    |que continham números sem sentido. Os valores: 0 ou 1, true ou false, foram mudados para Sim ou       |Não.
